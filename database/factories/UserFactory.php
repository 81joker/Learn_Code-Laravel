...
$factory->define(Cource::class, function (Faker $faker) {
    return [
...
$factory->define(Vadio::class, function (Faker $faker) {
    return [
    	'title' => $faker->sentence,
    	'link' => $faker->url,
    	'course_id' => Cource::all()->random()->id,
    ];
});
...
$factory->define(Photo::class, function (Faker $faker) {
	...
	$courseid = Cource::all()->random()->id;

	$photoable_id = $faker->randomElement([ $userid, $courseid ]);
	$photoable_type = $photoable_id == $userid ? 'App\User' : 'App\Cource';
