...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                    <i class="fas fa-home" style="color: #f4645f;"></i>
                    <span class="nav-link-text" style="color: #f4645f;">{{ __('Tracks') }}</span>
                </a>
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('admins.create') }}" class="btn btn-sm btn-primary">{{ __('Add Track') }}</a>
                        ...
                        <tbody>
                            @foreach ($tracks as $track)
                                <tr>
                                    <td>{{ $track->name }}</td>
                                    <td>
                                        <a href="mailto:{{ $track->id }}">{{ $track->id  }}</a>
                                    </td>
